...
namespace ProgrammingAssignment3
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            grock = Content.Load<Texture2D>(@"graphics/greenrock");
            mrock = Content.Load<Texture2D>(@"graphics/magentarock");
            wrock = Content.Load<Texture2D>(@"graphics/whiterock");
