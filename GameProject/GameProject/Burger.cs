    ...
    public class Burger
    {
        ...
        public void Update(GameTime gameTime, MouseState mouse)
        {
            ...
            if (health > 0)
            {
                ...
                drawRectangle.X = mouse.Position.X - drawRectangle.Width / 2;
                drawRectangle.Y = mouse.Position.Y - drawRectangle.Height / 2;
                // clamp burger in window
                if (drawRectangle.Left < 0) { drawRectangle.X = 0; }
                if (drawRectangle.Right > GameConstants.WindowWidth) { drawRectangle.X = GameConstants.WindowWidth - drawRectangle.Width; }
                if (drawRectangle.Top < 0) { drawRectangle.Y = 0; }
                if (drawRectangle.Bottom > GameConstants.WindowHeight) { drawRectangle.Y = GameConstants.WindowHeight - drawRectangle.Height; }
